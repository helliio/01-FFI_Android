...
public class DatabasePopulator {
    ...
    public void registerAllNewMembers(UserService userService)
    {
        ...
        userService.register(Coder.encryptMD5("to"), "test", "Tore", "1");
        userService.register(Coder.encryptMD5("pe"), "test", "Per", "1");
        userService.register(Coder.encryptMD5("bå"), "test", "Bård", "1");
        userService.register(Coder.encryptMD5("ch"), "test", "Chun", "1");
        userService.register(Coder.encryptMD5("ju"), "test", "Junjun", "1");
    ...
    public void loginAllNewMembers(UserService userService)
    {
        ...
        userService.login(Coder.encryptMD5("to"), "1", "test", TIME_IN_MILLI);
        userService.login(Coder.encryptMD5("pe"), "2", "test", TIME_IN_MILLI);
        userService.login(Coder.encryptMD5("bå"), "3", "test", TIME_IN_MILLI);
        userService.login(Coder.encryptMD5("ch"), "4", "test", TIME_IN_MILLI);
        userService.login(Coder.encryptMD5("ju"), "5", "test", TIME_IN_MILLI);
    ...
    {
        String result = "";
        result +=  " >>>>>    " + reportService.sendLocationReport(Coder.encryptMD5("to"), "1", TIME_IN_MILLI, "63.448243", "10.444393") + "\n";
        result += " >>>>>    " + reportService.sendLocationReport(Coder.encryptMD5("pe"), "2", TIME_IN_MILLI, "63.448250", "10.440501") + "\n";
        result += " >>>>>    " + reportService.sendLocationReport(Coder.encryptMD5("bå"), "3", TIME_IN_MILLI, "63.204424", "10.301304") + "\n";
        result += " >>>>>    " + reportService.sendLocationReport(Coder.encryptMD5("ch"), "4", TIME_IN_MILLI, "63.300404", "10.419923") + "\n";
        result += " >>>>>    " + reportService.sendLocationReport(Coder.encryptMD5("ju"), "5", TIME_IN_MILLI, "63.100233", "10.350023") + "\n";
        result += " >>>>>    " + reportService.sendLocationReport(Coder.encryptMD5("si"), "6", TIME_IN_MILLI, "63.321233", "10.401234") + "\n";
        result += " >>>>>    " + reportService.sendLocationReport(Coder.encryptMD5("mo"), "7", TIME_IN_MILLI, "63.204343", "10.372344") + "\n";
        result += " >>>>>    " + reportService.sendLocationReport(Coder.encryptMD5("tbs"), "8", TIME_IN_MILLI, "63.450031", "10.424243") + "\n";
    ...
    {
        String result = "";
        result += " >>>>>   " + reportService.sendTextReport(Coder.encryptMD5("to"), "1", TIME_IN_MILLI, "63.428253", "10.444384", "This is a message from user TO") + "\n";
        result += " >>>>>   " + reportService.sendTextReport(Coder.encryptMD5("pe"), "2", TIME_IN_MILLI, "63.458221", "10.444342", "This is a message from user PE") + "\n";
        result += " >>>>>   " + reportService.sendTextReport(Coder.encryptMD5("bå"), "3", TIME_IN_MILLI, "63.418243", "10.444353", "This is a message from user BÅ") + "\n";
        result += " >>>>>   " + reportService.sendTextReport(Coder.encryptMD5("ch"), "4", TIME_IN_MILLI, "63.458240", "10.444312", "This is a message from user CH") + "\n";
        result += " >>>>>   " + reportService.sendTextReport(Coder.encryptMD5("ju"), "5", TIME_IN_MILLI, "63.418210", "10.444301", "This is a message from user JU") + "\n";
        result += " >>>>>   " + reportService.sendTextReport(Coder.encryptMD5("si"), "6", TIME_IN_MILLI, "63.428213", "10.444391", "This is a message from user SI") + "\n";
        result += " >>>>>   " + reportService.sendTextReport(Coder.encryptMD5("mo"), "7", TIME_IN_MILLI, "63.408280", "10.444321", "This is a message from user MO") + "\n";
        result += " >>>>>   " + reportService.sendTextReport(Coder.encryptMD5("tbs"), "8", TIME_IN_MILLI, "63.418295", "10.44455", "This is a message from user TBS") + "\n";
    ...
    {
        String result = "";
        result += ">>>>>    " + reportService.sendPhotoReport(Coder.encryptMD5("to"), "1", TIME_IN_MILLI, "63.382438", "9.955673", "0",
